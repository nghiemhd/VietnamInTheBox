    ...
    public partial class CategoryModel : BaseNopEntityModel, ILocalizedModel<CategoryLocalizedModel>
    {
        ...
        public partial class AddCategoryProductModel : BaseNopModel
        {
            public AddCategoryProductModel()
            {
                ...
                AvailableProductStatus = new List<SelectListItem>();
            }
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.List.SearchProductStatus")]
            public bool? SearchProductStatus { get; set; }
            ...
            public IList<SelectListItem> AvailableProductStatus { get; set; }
