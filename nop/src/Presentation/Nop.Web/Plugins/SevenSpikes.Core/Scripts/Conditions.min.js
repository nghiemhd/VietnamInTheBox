...
function addKendoGridForConditionGroup(conditionGroupId) {
    ...
    $("#" + conditionGroupGridId).kendoGrid({
        ...
        edit: function (e) {
            ...
            if (model.ConditionType != undefined && model.ConditionProperty != undefined && model.OperatorType != undefined && model.Value != undefined) {
                $("#condition-type").attr("data-editValue", model.ConditionType);
                $("#condition-property").attr("data-editValue", model.ConditionProperty);
        ...
        save: function (e) {
            ...
            popupValues.ConditionProperty = $("#condition-property").val();
...
function SetSelectedConditionProperty(conditionType) {
    ...
    if (conditionProperty != undefined && conditionProperty != "") {
        ...
        for (var i = 0; i < conditionType.ConditionProperties.length; i++) {
            ...
            if (conditionType.ConditionProperties[i].ConditionProperty == conditionProperty) {
