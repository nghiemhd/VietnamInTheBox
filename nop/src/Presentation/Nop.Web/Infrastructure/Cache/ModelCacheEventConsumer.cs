...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<ProductTemplate>>
    {
        ...
        public void HandleEvent(EntityUpdated<Product> eventMessage)
        {
            ...
            Donut_RemoveProduct(eventMessage.Entity.Id);
        }
        ...
        private void Donut_RemoveProduct(int id)
        {
            var cache = new OutputCacheManager();
            cache.RemoveItem("Catalog", "Product", new {productId = id });
        }
