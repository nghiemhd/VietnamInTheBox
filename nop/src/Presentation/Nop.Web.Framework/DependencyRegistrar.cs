...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<SaleOrderService>().As<ISaleOrderService>().InstancePerHttpRequest();
            builder.RegisterType<InventoryService>().As<IInventoryService>().InstancePerHttpRequest();
            builder.RegisterType<PurchaseInvoiceService>().As<IPurchaseInvoiceService>().InstancePerHttpRequest();
            builder.RegisterType<GeneralLedgerService>().As<IGeneralLedgerService>().InstancePerHttpRequest();
