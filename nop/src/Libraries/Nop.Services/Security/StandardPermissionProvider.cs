...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord DeleteProducts = new PermissionRecord { Name = "Admin area. Delete Products", SystemName = "DeleteProducts", Category = "Catalog" };
        public static readonly PermissionRecord PublishProducts = new PermissionRecord { Name = "Admin area. Publish Products", SystemName = "PublishProducts", Category = "Catalog" };
        ...
        public static readonly PermissionRecord EditSystemCat = new PermissionRecord { Name = "Admin area. Alow edit system cat", SystemName = "EditSystemCat", Category = "Catalog" };
        ...
        public static readonly PermissionRecord Aero87Admin = new PermissionRecord { Name = "Aero87 Admin", SystemName = "Aero87_AD", Category = "Configuration" };
        public static readonly PermissionRecord Aero87POS = new PermissionRecord { Name = "Aero87 POS", SystemName = "Aero87_POS", Category = "Configuration" };
        public static readonly PermissionRecord Aero87CheckSOPayment = new PermissionRecord { Name = "Aero87 Check SO Payment", SystemName = "Aero87_CheckSOPayment", Category = "Configuration" };
        public static readonly PermissionRecord Aero87CreateIT = new PermissionRecord { Name = "Aero87 Create Inventory Transfer", SystemName = "Aero87_CreateInventoryTransfer", Category = "Configuration" };
        public static readonly PermissionRecord Aero87ConfirmIT = new PermissionRecord { Name = "Aero87 Confirm Inventory Transfer", SystemName = "Aero87_ConfirmInventoryTransfer", Category = "Configuration" };
        public static readonly PermissionRecord Aero87EditPrice = new PermissionRecord { Name = "Aero87 Edit Product Price", SystemName = "Aero87_EditPrice", Category = "Configuration" };
        public static readonly PermissionRecord Aero87EditProduct = new PermissionRecord { Name = "Aero87 Edit Product", SystemName = "Aero87_EditProduct", Category = "Configuration" };
