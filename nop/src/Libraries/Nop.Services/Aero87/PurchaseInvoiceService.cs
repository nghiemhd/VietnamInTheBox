...
namespace Nop.Services.Aero87
{
    public class PurchaseInvoiceService : IPurchaseInvoiceService
    {
        ...
        public IList<PurchaseInvoicesResult> Search(
            DateTime? fromDate,
            DateTime? toDate,
            int? storeId,
            int? status,
            ...
            )
        {
            ...
            var rs = _dbContext.SqlQuery<PurchaseInvoicesResult>(@"exec usp_PurchaseInvoiceSearch @fromDate, @toDate, @storeId, @status, @invoiceNo, @refNo, @productCode, @barcode, @pageIndex, @pageSize, @count output, @sumAmount output, @sumQty output",
                pfromDate, ptoDate, pstoreId, pstatus, pinvoiceNo, prefNo,
                pproductCode, pbarcode, ppageIndex, ppageSize, pTotalRecords, psumAmount,psumQty).ToList();
        ...
        public IList<PurchaseInvoiceDetailLinesResult> GetPurchaseInvoiceDetail(
            int invoiceId,
            int pageIndex, int pageSize,
            out int totalRecord)
        {
            ...
            var rs = _dbContext.SqlQuery<PurchaseInvoiceDetailLinesResult>(@"exec usp_GetPurchaseInvoiceDetailById @invoiceId, @pageIndex, @pageSize, @count output", pinvoiceId, ppageIndex, ppageSize, pTotalRecords).ToList();
            totalRecord = (int)pTotalRecords.Value;
            ...
            )
        {
            ...
            _dbContext.ExecuteSqlCommand(@"exec usp_PurchaseInvoice_Approve @invoiceId, @creditAcctId, @objId, @desc, @user", false, 10000,
                pinvoiceId, pcreditAcctId, pobjId, pdesc, puser
                );
        }
            ...
            )
        {
            ...
            _dbContext.ExecuteSqlCommand(@"exec usp_PurchaseInvoice_UnPost @invoiceId, @user", false, 10000,
                pinvoiceId, puser
                );
        }
    }
