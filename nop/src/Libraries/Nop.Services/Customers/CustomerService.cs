...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
            ...
            DateTime? createdToUtc, bool onlyWithoutShoppingCart, int maxNumberOfRecordsToDelete)
        {
            ...
            var ctx = EngineContext.Current.Resolve<IDbContext>() as DbContext;
            var ab = ctx.Configuration.AutoDetectChangesEnabled;
            ...
            {
                ctx.Configuration.AutoDetectChangesEnabled = ab;
            }
