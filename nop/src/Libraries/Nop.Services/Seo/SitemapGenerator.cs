...
namespace Nop.Services.Seo
{
    ...
    public partial class SitemapGenerator : BaseSitemapGenerator, ISitemapGenerator
    {
            ...
            CommonSettings commonSettings)
        {
            ...
            this._cache = EngineContext.Current.ContainerManager.Resolve<ICacheManager>("nop_cache_static"); ;
        }


        private const string key = "SEOCACHE";
        public override string Generate(UrlHelper urlHelper)
        {
            return _cache.Get<string>(key, 1440, () =>
            {
