    ...
    public partial class ProductService : IProductService
    {
            ...
            bool? publishStatus = null)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                searchProductTags, languageId, filteredSpecs, orderBy, showHidden, publishStatus);
        }
            ...
            bool? publishStatus = null )
        {
            ...
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                var pPublishStatus = _dataProvider.GetParameter();
                pPublishStatus.ParameterName = "PublishStatus";
                pPublishStatus.Value = publishStatus;
                pPublishStatus.DbType = DbType.Boolean;
        ...
        public string GetPIInvoiceNo()
        {
            var pTranType = _dataProvider.GetParameter();
            pTranType.DbType = DbType.String;
            pTranType.ParameterName = "TranType";
            pTranType.Value = "PI";

            return _dbContext.SqlQuery<string>("exec usp_Get_Next_Number @TranType", pTranType).FirstOrDefault();
        }

        public int CreateAndEditBarcode(int productId, string barcode, string attValueIds)
        {
            ...
            var pAttValueIds = _dataProvider.GetParameter();
            pAttValueIds.DbType = DbType.String;
            pAttValueIds.ParameterName = "ProductVariantAttributeValueIds";
            pAttValueIds.Value = attValueIds;

            var pBarcodeIdOut = _dataProvider.GetParameter();
            pBarcodeIdOut.DbType = DbType.Int32;
            pBarcodeIdOut.ParameterName = "BarcodeIdOut";
            pBarcodeIdOut.Direction = ParameterDirection.Output;

            _dbContext.ExecuteSqlCommand("usp_editBarcode @Barcode,@ProductId,@ProductVariantAttributeValueIds,@BarcodeIdOut OUTPUT",false, null, pBarcode, pProductId, pAttValueIds, pBarcodeIdOut);

            return Convert.ToInt32(pBarcodeIdOut.Value);
        }

        public int CreateAndEditPI(int storeId, string invoiceNo, string refNo, DateTime invoiceDate, string desc)
        {
            ...
            var pInvoiceDate = _dataProvider.GetParameter();
            pInvoiceDate.DbType = DbType.DateTime;
            pInvoiceDate.ParameterName = "InvoiceDate";
            ...
            var pIdOut = _dataProvider.GetParameter();
            pIdOut.DbType = DbType.Int32;
            pIdOut.ParameterName = "IdOut";
            pIdOut.Direction = ParameterDirection.Output;

            _dbContext.ExecuteSqlCommand("usp_editPurchaseInvoice @StoreId, @InvoiceNo,@RefNo,@InvoiceDate,@Desc,@IdOut output", false, null, pStoreId, pInvoiceNo, pRefNo, pInvoiceDate, pDesc, pIdOut);

            return Convert.ToInt32(pIdOut.Value);
        }

        public void CreatePIDetail(int PurchaseInvoiceId, int BarcodeId, int Qty, decimal Price, decimal Amount)
        {
            var pPurchaseInvoiceId = _dataProvider.GetParameter();
            pPurchaseInvoiceId.DbType = DbType.Int32;
            pPurchaseInvoiceId.ParameterName = "PurchaseInvoiceId";
            pPurchaseInvoiceId.Value = PurchaseInvoiceId;

            var pBarcodeId = _dataProvider.GetParameter();
            pBarcodeId.DbType = DbType.Int32;
            pBarcodeId.ParameterName = "BarcodeId";
            pBarcodeId.Value = BarcodeId;
            ...
            var pAmount = _dataProvider.GetParameter();
            pAmount.DbType = DbType.Decimal;
            pAmount.ParameterName = "Amount";
            pAmount.Value = Amount;


            _dbContext.ExecuteSqlCommand("usp_editPurchaseInvoiceDetail @PurchaseInvoiceId,@BarcodeId,@Qty,@Price,@Amount", false, null, pPurchaseInvoiceId, pBarcodeId, pQty, pPrice, pAmount);
        }

        public IList<CF_Store> GetStoreProductStocking(int productId)
        {
            var pProductId = _dataProvider.GetParameter();
            pProductId.DbType = DbType.Int32;
            pProductId.ParameterName = "ProductId";
            ...
            var result = _dbContext.SqlQuery<CF_Store>("usp_GetStoreProductStocking @ProductId", pProductId).ToList();
            return result;
        }
        ...
        public int GetInventoryQuantity(int productId)
        {
            ...
            var result = _dbContext.SqlQuery<int>("usp_GetInventoryQuantity @ProductId", pProductId).FirstOrDefault();
            return result;
        }
        #endregion
    }
