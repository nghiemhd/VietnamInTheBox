...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        string GetPIInvoiceNo();
        int CreateAndEditBarcode(int productId, string barcode, string attValueIds);
        int CreateAndEditPI(int storeId, string invoiceNo, string refNo, DateTime invoiceDate, string desc);
        void CreatePIDetail(int PurchaseInvoiceId, int BarcodeId, int Qty, decimal Price, decimal Amount);
        IList<CF_Store> GetStoreProductStocking(int productId);
        int GetInventoryQuantity(int productId);
        #endregion
    }
}
