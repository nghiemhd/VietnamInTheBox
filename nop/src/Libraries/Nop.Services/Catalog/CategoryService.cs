...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        public virtual void DeleteAllProductsByCategoryId(int categoryId)
        {
            var pcategoryId = _dataProvider.GetParameter();
            pcategoryId.ParameterName = "categoryId";
            pcategoryId.Value = ((object)categoryId) ?? DBNull.Value;
            pcategoryId.DbType = DbType.Int32;

            _dbContext.ExecuteSqlCommand(@"exec usp_DeleteAllProductsByCategoryId @categoryId", false, 10000, pcategoryId);
        }
