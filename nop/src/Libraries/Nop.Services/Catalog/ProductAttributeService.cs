...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        public virtual ProductAttribute GetProductAttributeByName(string name)
        {
            ...
            string key = string.Format(PRODUCTATTRIBUTES_BY_ID_KEY, name);
            return _cacheManager.Get(key, () => { return _productAttributeRepository.Table.Where( a => a.Name == name).FirstOrDefault(); });
        }
