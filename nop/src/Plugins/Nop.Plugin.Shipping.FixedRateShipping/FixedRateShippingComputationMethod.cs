...
namespace Nop.Plugin.Shipping.FixedRateShipping
{
    ...
    public class FixedRateShippingComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public decimal? GetFixedRate(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            if (getShippingOptionRequest.Customer != null && getShippingOptionRequest.Customer.ShippingAddress != null)
            {
                var address = getShippingOptionRequest.Customer.ShippingAddress;
                if (address.City != null && address.City == "HCM") return 20000;

                if (address.City != null && address.City == "Other") return 40000;

                if (address.Address1 == null) return null;
